...
class Skill
{
	...
	containsCtrl()
	{
		return st_contains(this.hotkey, "^")
	}
...
SkillMap := {}
; Bar 1
SkillMap["BasicTouch"] := new Skill("1", 3000)
SkillMap["StandardTouch"] := new Skill("2", 3000)
SkillMap["AdvancedTouch"] := new Skill("3", 3000)
SkillMap["PreciseTouch"] := new Skill("4", 3000)
SkillMap["StandardSynthesis"] := new Skill("5", 3000)
SkillMap["MastersMend2"] := new Skill("6", 3000)
SkillMap["MastersMend"] := new Skill("7", 3000)
SkillMap["InnerQuiet"] := new Skill("8", 2200)
SkillMap["GreatStrides"] := new Skill("9", 2200)
SkillMap["SteadyHand"] := new Skill("0", 2200)
SkillMap["Observe"] := new Skill("-", 3000)
SkillMap["Collectible"] := new Skill("=", 3000)

; bar 2
SkillMap["HastyTouch2"] := new Skill("^1", 3000)
SkillMap["CarefulSynthesis3"] := new Skill("^2", 3000)
SkillMap["RapidSynthesis2"] := new Skill("^3", 3000)
SkillMap["PatientTouch"] := new Skill("^4", 3000)
SkillMap["Manipulation2"] := new Skill("^5", 3000)
SkillMap["PrudentTouch"] := new Skill("^6", 3000)
SkillMap["FocusedSynthesis"] := new Skill("^7", 3000)
SkillMap["FocusedTouch"] := new Skill("^8", 3000)
SkillMap["InitialPreperations"] := new Skill("^9", 3000)

; Bar 3
SkillMap["HastyTouch"] := new Skill("!1", 3000)
SkillMap["ByregotsBlessing"] := new Skill("!2", 3000)
SkillMap["RapidSynthesis"] := new Skill("!3", 3000)
SkillMap["CarefulSynthesis"] := new Skill("!4", 3000)
SkillMap["CarefulSynthesis2"] := new Skill("!5", 3000)
SkillMap["SteadyHand2"] := new Skill("!6", 3000)
SkillMap["InnovativeTouch"] := new Skill("!7", 3000)
SkillMap["Innovation"] := new Skill("!8", 3000)
SkillMap["PieceByPiece"] := new Skill("!9", 3000)
SkillMap["FlawlessSynthesis"] := new Skill("!0", 3000)
SkillMap["MakersMark"] := new Skill("!-", 3000)
SkillMap["MuscleMemory"] := new Skill("!=", 3000)

; Bar 4
SkillMap["Manipulation"] := new Skill("^!1", 3000)
SkillMap["WasteNot"] := new Skill("^!2", 3000)
SkillMap["WasteNot2"] := new Skill("^!3", 3000)
SkillMap["TricksOfTheTrade"] := new Skill("^!4", 3000)
SkillMap["Rumination"] := new Skill("^!5", 3000)
SkillMap["Ingenuity"] := new Skill("^!6", 3000)
SkillMap["Ingenuity2"] := new Skill("^!7", 3000)
SkillMap["ComfortZone"] := new Skill("^!8", 3000)
SkillMap["Reclaim"] := new Skill("^!9", 3000)
...
Dialog()
{
	...
	Gui, Crafting:Add, DropDownList, r10 x162 y39 w140 h10 vMacroName, 1to50|60lv70dur|60to65dur40|60to65dur80|66to70dur80
